...
class Navbar:
    ...
    def check_navbar(self):
        ...
        time.sleep(3)
        expect(self.page.locator("h1.font-semibold")).to_contain_text("Clinrol clinical trials")

        # researchers
        self.page.get_by_role("link", name="Researchers").click()
        time.sleep(2)
        expect(self.page.locator("h1.text-coolGray-900")).to_contain_text("Patient recruitment for researchers")
